...
from rakshaclient import service_catalog
from rakshaclient import utils


class HTTPClient(object):

    USER_AGENT = 'python-rakshaclient'

    def __init__(self, user, password, projectid, auth_url, insecure=False,
                 timeout=None, tenant_id=None, proxy_tenant_id=None,
                 proxy_token=None, region_name=None,
                 endpoint_type='publicURL', service_type=None,
                 service_name=None, vault_service_name=None, retries=None,
        ...
        self.vault_service_name = vault_service_name
        ...
        if resp.status_code == 200:  # content must always present
            try:
                ...
                management_url = self.service_catalog.url_for(
                    ...
                    vault_service_name=self.vault_service_name)
    ...
    def authenticate(self):
        ...
        if self.version == "v2.0":
            while auth_url:
                if "RAKSHA_RAX_AUTH" in os.environ:
            ...
            # In some configurations raksha makes redirection to
...
def get_client_class(version):
    version_map = {
        '1': 'rakshaclient.v1.client.Client',
    }
    try:
