...
def install_dependencies(venv=VENV):
    ...
    # Tell the virtual env how to "import raksha"
...
def print_help():
    help = """
    python-rakshaclient development environment setup is complete.

    python-rakshaclient development uses virtualenv to track and manage Python
    dependencies while in development and testing.

    To activate the python-rakshaclient virtualenv for the extent of your
